...
(function() {
  var ActiveRecord, all, association, config_db, config_db_pool, connection, delete_, find, getRows, getTableName, get_data_all_where, inject_data, insert_value, my_rows_global, mysql, save, save_association, update_value, uuid, where, _defineProperties;
  ...
  delete_ = function() {
    ...
    return connection.query(request_delete, [this[that['config']['name_id']]], function(err, result) {});
  };
  ...
  ActiveRecord = function(infos) {
    ...
    init = function(that, infos) {
      ...
      that['config'] = {
        ...
        my_constraint: '',
        name_id: (infos.name_id != null) && !infos.name_id ? infos.name_id : 'id',
